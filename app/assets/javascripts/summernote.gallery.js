                                ...
                                + '<div class="modal-lg modal-dialog ">'
                                    + '<div class="modal-content">'
                                        + '<div class="modal-header">'
                                            ...
                                            + '<h4 class="modal-title">Bilde galleri</h4>'
                                        + '</div>'
                                        ...
                                        + '<div class="modal-footer">'
                                            + '<button type="button" id="close" class="btn btn-default" data-dismiss="modal">Lukk</button>'
                                            + '<button type="button" id="save" class="btn btn-primary">Legge til</button>'
                                        + '</div>'
                                    + '</div>'
                                + '</div>'
                            + '</div>';
            ...
            this.initialize = function()
            {
                ...
                this.$css = $('<style>'
                                ...
                                +'.img-item .zmdi-check{'
                                    +'display : none;'
                                +'}'
                                +'.img-item .'+ this.select_class +' + .zmdi-check{'
                                    +'display : block;'
                                +'}'
                                +'.'+ this.select_class +'{'
